...
import com.iflytek.mvvm_module_cli.main_module.databinding.FragmentMainBinding


/**
 * Created by Jianxin on 2021/1/27.
 */
@Route(path = ConstantRouterPath.PATH_FRAGMENT_MAIN_MAIN)
class MainFragment : BaseFragment<FragmentMainBinding>(),
    ...
    override fun onClick(v: View?) {
        ARouter.getInstance().build(ConstantRouterPath.PATH_ACTIVITY_MAIN_MAINDETAIL).navigation()
    }
